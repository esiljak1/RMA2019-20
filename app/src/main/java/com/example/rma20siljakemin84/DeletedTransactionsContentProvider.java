...
public class DeletedTransactionsContentProvider extends ContentProvider {
    ...
    static {
        ...
        uM.addURI("rma.provider.deletedTransactionsTable", "elements", ALLROWS);
        uM.addURI("rma.provider.deletedTransactionsTable", "elements/#", ONEROW);
    }
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection, @Nullable String[] selectionArgs, @Nullable String sortOrder) {
        ...
        squery.setTables(TransactionDBOpenHelper.DELETED_TRANSACTIONS_TABLE);
    ...
    public String getType(@NonNull Uri uri) {
        switch (uM.match(uri)){
            ...
            default:
                throw new IllegalArgumentException("Unusported uri " + uri.toString());
        }
    }
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues values) {
        ...
        long id = database.insert(TransactionDBOpenHelper.DELETED_TRANSACTIONS_TABLE, null, values);
    ...
    public int delete(@NonNull Uri uri, @Nullable String selection, @Nullable String[] selectionArgs) {
        ...
        database.delete(transactionDBOpenHelper.DELETED_TRANSACTIONS_TABLE, selection, selectionArgs);
        return 0;
    }
    ...
    public int update(@NonNull Uri uri, @Nullable ContentValues values, @Nullable String selection, @Nullable String[] selectionArgs) {
        ...
        database.update(TransactionDBOpenHelper.DELETED_TRANSACTIONS_TABLE, values, selection, selectionArgs);
        return 0;
    }
}
