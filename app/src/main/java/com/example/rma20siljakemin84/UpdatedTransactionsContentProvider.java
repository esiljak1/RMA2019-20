...
public class UpdatedTransactionsContentProvider extends ContentProvider {
    ...
    static {
        ...
        uM.addURI("rma.provider.updatedTransactions", "elements", ALLROWS);
        uM.addURI("rma.provider.updatedTransactions", "elements/#", ONEROW);
    }
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection, @Nullable String[] selectionArgs, @Nullable String sortOrder) {
        ...
        squery.setTables(TransactionDBOpenHelper.UPDATED_TRANSACTIONS_TABLE);
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues values) {
        ...
        long id = database.insert(TransactionDBOpenHelper.UPDATED_TRANSACTIONS_TABLE, null, values);
    ...
    public int delete(@NonNull Uri uri, @Nullable String selection, @Nullable String[] selectionArgs) {
        ...
        database.delete(TransactionDBOpenHelper.UPDATED_TRANSACTIONS_TABLE, selection, selectionArgs);
        return 0;
    }
    ...
    public int update(@NonNull Uri uri, @Nullable ContentValues values, @Nullable String selection, @Nullable String[] selectionArgs) {
        ...
        database.update(TransactionDBOpenHelper.UPDATED_TRANSACTIONS_TABLE, values, selection, selectionArgs);
        return 0;
    }
}
